...
```powershell
python scripts/value_lab.py --enable-extensions team-card .\study\suite.json .\study\runs.jsonl --lock .\study\protocol.lock.json --decision .\decision.json --research .\research-context.json --output .\team\revision-1
```
