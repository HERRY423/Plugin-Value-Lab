...
DIRECTORIES = (".codex-plugin", ".claude-plugin", "com.openai", "value_lab", "scripts", "skills", "docs", "examples", "evals", "tests", "schemas")
FILES = ("plugin.json", "mcp.json", ".mcp.json", ".gitignore", "README.md", "CHANGELOG.md", "CONTRACT.md", "pyproject.toml", "requirements-mcp.txt", "VERIFICATION.json")
